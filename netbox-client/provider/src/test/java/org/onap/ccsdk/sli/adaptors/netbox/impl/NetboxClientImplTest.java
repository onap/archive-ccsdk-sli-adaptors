...
public class NetboxClientImplTest {
    ...
    @Rule
    public WireMockRule wm = new WireMockRule(wireMockConfig().port(8765));

    private String baseUrl = "http://localhost:8765";
    private String token = "token";

    private NetboxHttpClient httpClient = new NetboxHttpClient(baseUrl, token);
    private NetboxClientImpl netboxClient = new NetboxClientImpl(httpClient);
...
//        netboxClient = new NetboxClientImpl(httpClient);
    ...
    public void nextAvailableIpInPrefixTestNoId() {
        ...
        netboxClient.nextAvailableIpInPrefix(prefix).toCompletableFuture().join();
    }
